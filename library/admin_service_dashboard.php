...
<html>
    ...
    <body>
        <div class="container">
        <div class="innerdiv">
        <div class="row"><img class="imglogo" src="images/3195.png"/></div>
...
<div class="rightinnerdiv">   
            ...
            <div>Branch:<input type="radio" name="branch" value="other"/>other<input type="radio" name="branch" value="Novel"/>Novel<div style="margin-left:80px"><input type="radio" name="branch" value="Textbook"/>Textbook<input type="radio" name="branch" value="Reference"/>Reference</div>
            </div>   
...
<!--addbook -->
            ...
            <label>Publication</label><input type="text" name="bookpub"/></br>
            <div>Branch:<input type="radio" name="branch" value="other"/>other<input type="radio" name="branch" value="Fantasy"/>Fantasy<div style="margin-left:80px"><input type="radio" name="branch" value="Fiction"/>Fiction<input type="radio" name="branch" value="Non-Fiction"/>Non-Fiction</div>
            </div>   
            <label>Price:</label><input  type="number" name="bookprice"/></br>
            <label>Quantity:</label><input type="number" name="bookquantity"/></br>
            <label>Book Photo</label><input  type="file" name="bookphoto"/></br>
